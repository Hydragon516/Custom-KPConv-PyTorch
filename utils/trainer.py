...
class ModelTrainer:
    ...
    def __init__(self, net, config, chkp_path=None, finetune=False, on_gpu=True, num_classes=3):
        """
    ...
    def train(self, net, training_loader, val_loader, config):
        ...
        for epoch in range(config.max_epoch):
            ...
            for batch in training_loader:
                ...
                # print(torch.mean(batch.features.squeeze(1)))
    ...
    def object_classification_validation(self, net, val_loader, config):
        ...
        if not hasattr(self, 'val_probs'):
            print(val_loader.dataset.num_models, nc_model)
